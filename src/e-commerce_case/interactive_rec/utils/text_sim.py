...
class SentBERTEngine:
    def __init__(self, corpus: np.ndarray, index: np.ndarray, case_sensitive: bool = False,
                 model_name: str = 'thenlper/gte-base', keep_embedding: bool = False, model=None):
        self.corpus = corpus
        self.index = index
    ...
    def __call__(self, query: Union[str, List[str]], return_doc=False, topk: int = None,
                 thres: float = None) -> np.ndarray:
